...
// const { calculateSlope, calculateNOfLineFunction } = require('../../../modules/ecs6-class/line')
  ...
  describe('CONSTRUCTOR', () => {
    ...
    describe('CALCULATE_N_Of_LINE_FUNCTION', () => {
      it('should return the point of intersection of the line with the y-axis', () => {
        const l = new Line({ point1: new Point({ x: 3, y: 6 }), point2: new Point({ x: 1, y: 2 }), slope: 2 })
    ...
    describe('GET_POINT_BY_X', () => {
      it('should calculate the correct y value for a given x value', () => {
        const l = new Line({ point1: new Point({ x: 2, y: 5 }), point2: new Point({ x: 1, y: 6 }), slope: -1, n: 7 });
