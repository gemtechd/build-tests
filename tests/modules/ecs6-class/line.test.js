...
describe('LINE', () => {
    describe('CONSTRUCTOR', () => {
        ...
        it('should throw error when the values are not a numbers', () => {
            expect(() => new Line({ n: 3, slope: "5" })).toThrow('slope is not a number')
            expect(() => new Line({ n: '3', slope: 3 })).toThrow('n is not a number')
            expect(() => new Line({ n: [5, 7], slope: 6 })).toThrow('n is not a number')
            expect(() => new Line({ n: 3, slope: { x: 7, y: 5 } })).toThrow('slope is not a number')
        })
    })

    describe('CALCULATE_SLOPE', () => {
        it('should calculate the slope of the line', () => {
            const line = new Line({ point1: new Point({ x: 0, y: 0 }), point2: new Point({ x: 1, y: 2 }) });
            line.calculateSlope();
            expect(line.slope).toBe(2);
        });
        ...
        it('should throw error when division by zero is performed', () => {
            const line = new Line({ point1: new Point({ x: 1, y: 0 }), point2: new Point({ x: 1, y: 2 }) });
    ...
    describe('CALCULATE_N_OF_LINE_FUNCTION', () => {
        it('should calculate the n value of the line function', () => {
            const line = new Line({ point1: new Point({ x: 0, y: 1 }), point2: new Point({ x: 1, y: 3 }), slope: 2 });
    ...
    describe('GET_POINT_ON_X_ASIS', () => {
        it('should return a Point on the X-axis', () => {
            const line = new Line({ point1: new Point({ x: 1, y: 1 }), point2: new Point({ x: 2, y: 2 }), slope: 1, n: 1 });
    ...
    describe('GET_POINT_ON_Y_ASIS', () => {
        it('should return a Point on the Y-axis', () => {
            const line = new Line({ point1: new Point({ x: 1, y: 1 }), point2: new Point({ x: 2, y: 2 }), slope: 1, n: 2 });
    ...
    describe('GET_POINT_BY_X', () => {
        it('should return a Point based on given X coordinate', () => {
            const line = new Line({ point1: new Point({ x: 1, y: 1 }), point2: new Point({ x: 3, y: 3 }), slope: 1, n: 5 });
    ...
    describe('GET_POINT_BY_Y', () => {
        it('should return a Point based on given Y coordinate', () => {
            const line = new Line({ point1: new Point({ x: 0, y: 0 }), point2: new Point({ x: 1, y: 1 }) });
            line.calculateSlope()
            line.calculateNOfLineFunction()
        ...
        it('should throw error when the y is not a number', () => {
            const line = new Line({ point1: new Point({ x: 1, y: 1 }), point2: new Point({ x: 3, y: 3 }), slope: 7, n: 5 });
        ...
        it('should throw error when division by zero is performed', () => {
            const line = new Line({ point1: new Point({ x: 1, y: 0 }), point2: new Point({ x: 1, y: 1 }), slope: 0, n: 0 });
